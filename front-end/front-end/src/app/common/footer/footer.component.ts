...
export class FooterComponent {
  ...
  socialLinks: SocialLink[] = [
    { url: 'https://facebook.com/', icon: 'icofont-facebook' },
    { url: 'https://plus.google.com/', icon: 'icofont-google-plus' },
    { url: 'https://twitter.com/', icon: 'icofont-twitter' },
    //{ url: 'https://vimeo.com/', icon: 'icofont-vimeo' },
    { url: 'https://pinterest.com/', icon: 'icofont-pinterest' },
  ];
